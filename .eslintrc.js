...
module.exports = {
  ...
  overrides: [
    ...
    },
    {
      ...
      rules: {
        "n8n-nodes-base/node-class-description-credentials-name-unsuffixed":
          "error",
        ...
        "n8n-nodes-base/node-class-description-inputs-wrong-regular-node":
          "off",
        "n8n-nodes-base/node-class-description-inputs-wrong-trigger-node":
          "error",
        ...
        "n8n-nodes-base/node-class-description-name-unsuffixed-trigger-node":
          "error",
        ...
        "n8n-nodes-base/node-param-description-excess-inner-whitespace":
          "error",
        "n8n-nodes-base/node-param-description-identical-to-display-name":
          "error",
        ...
        "n8n-nodes-base/node-param-description-unencoded-angle-brackets":
          "error",
        ...
        "n8n-nodes-base/node-param-description-wrong-for-dynamic-multi-options":
          "error",
        "n8n-nodes-base/node-param-description-wrong-for-dynamic-options":
          "error",
        "n8n-nodes-base/node-param-description-wrong-for-ignore-ssl-issues":
          "error",
        ...
        "n8n-nodes-base/node-param-display-name-excess-inner-whitespace":
          "error",
        ...
        "n8n-nodes-base/node-param-display-name-wrong-for-dynamic-multi-options":
          "error",
        "n8n-nodes-base/node-param-display-name-wrong-for-dynamic-options":
          "error",
        "n8n-nodes-base/node-param-display-name-wrong-for-simplify": "error",
        "n8n-nodes-base/node-param-display-name-wrong-for-update-fields":
          "error",
        ...
        "n8n-nodes-base/node-param-operation-option-action-wrong-for-get-many":
          "error",
        ...
        "n8n-nodes-base/node-param-operation-without-no-data-expression":
          "error",
        "n8n-nodes-base/node-param-option-description-identical-to-name":
          "error",
        ...
        "n8n-nodes-base/node-param-resource-without-no-data-expression":
          "error",
